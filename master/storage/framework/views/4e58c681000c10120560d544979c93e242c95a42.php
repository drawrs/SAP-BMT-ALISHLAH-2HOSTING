...
<div class="col-md-8">
    ...
    <tr>
        ...
        <div class="form-group">
            <input type="hidden" class="inputable" name="no_aplikasi" value="<?php echo e($no_app); ?>" required>
            <font size="4.2em" style="font-weight: bolder;" name=""><?php echo e($no_app); ?><span id="no_applikasi"></span></font>
            </div>
        </td>
    </tr>
