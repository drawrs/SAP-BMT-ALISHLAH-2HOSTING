...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo e($no++); ?></td>
            <td colspan="5"><input disabled="" type="text" class="form-control ctn" value="<?php echo e($ctn->isi); ?>" ctnid="<?php echo e($ctn->id); ?>"></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
    <tbody>
        <tr>
            ...
            <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_tgl_satu" value="<?php echo e(readDate($dokumen_ceklis->tgl_satu)); ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
            </td>
            <td >
                Tanggal : 
             </td>
             <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_tgl_dua" value="<?php echo e(readDate($dokumen_ceklis->tgl_dua)); ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_mark_satu" value="<?php echo e($dokumen_ceklis->mark_satu); ?>">
            </td>
            <td >
                Disusun Oleh : 
             </td>
             <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_mark_dua" value="<?php echo e($dokumen_ceklis->mark_dua); ?>">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_nama_satu" value="<?php echo e($dokumen_ceklis->nama_satu); ?>">
            </td>
            <td >
                Nama : 
             </td>
             <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_nama_dua" value="<?php echo e($dokumen_ceklis->nama_dua); ?>">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_jabatan_satu" value="<?php echo e($dokumen_ceklis->jabatan_satu); ?>">
            </td>
            <td >
                Jabatan : 
             </td>
             <td colspan="2">
                <input type="text" disabled='1' class="form-control inputable" name="tab6_jabatan_dua" value="<?php echo e($dokumen_ceklis->jabatan_dua); ?>">
            </td>
        </tr>
    </tbody>
</table>
