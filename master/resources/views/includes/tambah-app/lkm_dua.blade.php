...
<br>
  <div class="row">
  @for($i = 1; $i <= 3; $i++)
    <form action="" id="kpk_{{$i}}" class="form lkmDua">
    <input type="hidden" name="id" value="">
    <input type="hidden" name="tab4_lkm_pc_id" id="tab4_lkm_pc_id" value="">
    ...
    <table class="table table-responsive table-borderless">
      <tr>
        ...
        <td><input name="tab4_nama" type="text" class="form-control" value=""></td>
      </tr>
      <tr>
        <td>Hubungan</td>
        <td>
      ...
      <tr>
        ...
        <td><input name="tab4_telp"  type="text" class="form-control" value=""></td>
      </tr>
    </table>
  </div>
  </form>
